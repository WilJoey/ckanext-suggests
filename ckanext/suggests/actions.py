...
def suggest_close(context, data_dict):
    ...
    # Validate data
    validator.validate_suggest_closing(context, data_dict)
...
def suggest_comment(context, data_dict):
    ...
    :param suggest_id: The ID of the suggest to be commented
    :type id: string

    :param comment: The comment to be added to the data request
    :type comment: string

    :returns: A dict with the data request comment (id, user_id, suggest_id, time
        and comment)
    :rtype: dict
...
def suggest_comment_show(context, data_dict):
    ...
    :returns: A dict with the following fields: id, user_id, suggest_id, time
        and comment
    :rtype: dict
    '''
    ...
    # Check access
    tk.check_access(constants.SUGGEST_COMMENT_SHOW, context, data_dict)
...
def suggest_comment_list(context, data_dict):
    ...
    :param suggest_id: The ID of the suggest whose comments want to be retrieved
    :type id: string

    :returns: A list with all the comments of a data request. Every comment is a dict with the
    following fields: id, user_id, suggest_id, time and comment
    :rtype: list
    '''
    ...
    # Check access
    tk.check_access(constants.SUGGEST_COMMENT_LIST, context, data_dict)

    # Get comments
    comments_db = db.Comment.get_ordered_by_date(suggest_id=suggest_id)
...
def suggest_comment_update(context, data_dict):
    ...
    # Check access
    tk.check_access(constants.SUGGEST_COMMENT_UPDATE, context, data_dict)
...
def suggest_comment_delete(context, data_dict):
    ...
    # Check access
    tk.check_access(constants.SUGGEST_COMMENT_DELETE, context, data_dict)
